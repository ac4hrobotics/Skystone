...
@Autonomous(name="Auonomous_skystone_park", group="Pushbot")
public class Auonomous_skystone_park extends LinearOpMode {
 /**
  ...
  */
        ...
        public void runOpMode() {
            ...
            //LEFT MOTOR AND RIGHT MOTOR ARE SWAPPED ON ROBOT
            robot.Slidelift.setPower(-.25);//raise lift
            //encoderDrive(TURN_SPEED, 0,0,20,0,0,5);po
            ...
            sleep(2500);//wait for 2.5 sec
            robot.Rdrive.setPower(-1);
            robot.Ldrive.setPower(-1);//stops driving
            //===========================================
            robot.Lintake.setPower(.2);
            robot.Rintake.setPower(.2);//pulls block in
            sleep(500);//wait for .5 sec
            robot.Rintake.setPower(0);
            robot.Lintake.setPower(0);//stops pulling block in
            sleep(500);//wait for .5 sec
            //===========================================
